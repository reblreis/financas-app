...
*/
export function criarConta(request: CriarContaRequest): Observable<CriarContaResponse> {

    //configurando a requisição
    const config = {
        method: 'post',
        url: `${environment.apiUsuarios}/usuarios/criar-conta`,
        data: request
    };    
...
*/
export function autenticar(request: AutenticarRequest): Observable<AutenticarResponse> {
