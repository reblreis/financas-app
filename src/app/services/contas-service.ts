...
export function postContas(request: ContasRequest): 
Observable<ContasResponse> { 
    const config = { 
        method: 'post', 
...
export function putContas(request: ContasRequest): 
Observable<ContasResponse> { 
    const config = { 
        method: 'put', 
        url: `${environment.apiFinancas}/contas`, 
...
export function deleteContas(id: string): 
Observable<ContasResponse> { 
    const config = { 
        method: 'delete', 
...
export function getContas(dataMin : Date, dataMax: Date): 
Observable<ContasResponse[]> { 
    const config = { 
        method: 'get', 
